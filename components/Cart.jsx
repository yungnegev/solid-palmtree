...
const Cart = () => {
  ...
  let $placeholder = <div className='empty-cart'>
  ...
  let $cartItems = cartItems.map((item, index) => {
  ...
  let $subtotal = <div className='cart-bottom'>
                    <div className='total'>
                      <h3>Subtotal:</h3>
                      <h3>{`$${ totalPrice }`}</h3>
                    </div>
  ...
  return (
    <div className='cart-wrapper' ref={cartRef}>
      <div className='cart-container'>
        ...
        { cartItems.length === 0 && $placeholder }
        
        <div className='product-container'>
          { cartItems.length >= 1 && $cartItems }
        </div>
        
        {cartItems.length >= 1 && $subtotal}
